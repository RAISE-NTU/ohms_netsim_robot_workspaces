...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('input_cloud_topic', default_value='/bestla/velodyne_points'),
        DeclareLaunchArgument('resolution', default_value='0.10'),
        DeclareLaunchArgument('frame_id', default_value='bestla/map'),
        DeclareLaunchArgument('base_frame_id', default_value='bestla/base_link'),
